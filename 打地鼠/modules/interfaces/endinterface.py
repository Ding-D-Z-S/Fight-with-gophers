...
def endInterface(screen, end_image_path, again_image_paths, score_info, font_path, font_colors, screensize):
    ...
    your_score_text = font.render('你的分数: %s' % score_info['your_score'], True, font_colors[0])
    ...
    best_score_text = font.render('最高分数: %s' % score_info['best_score'], True, font_colors[1])
